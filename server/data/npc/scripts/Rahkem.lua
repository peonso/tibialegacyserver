...
elseif talk_state == 9081 and msgcontains(msg, 'yes') then
		...
		NPCSay("You don't have any premium coins!", 1)
		talk_state = 0			
		end
elseif talk_state == 9081 and msgcontains(msg, '') then
	NPCSay("Then not.", 1)
	talk_state = 0			
...
elseif talk_state == 9082 and msgcontains(msg, 'yes') then
		...
		NPCSay("You don't have enough donation points on your account!", 1)
		talk_state = 0			
		end
elseif talk_state == 9082 and msgcontains(msg, '') then
	NPCSay("Then not.", 1)
	talk_state = 0
...
elseif talk_state == 9083 and msgcontains(msg, 'yes') then
		if doPlayerRemoveItem(cid, ID_premiumcoin, 1) == true then
			...
			NPCSay("Something unecpected happened.", 1)
			talk_state = 0				
			end	
		else
		NPCSay("You don't have enough donation points on your account!", 1)
...
elseif talk_state == 9083 and msgcontains(msg, '') then
	NPCSay("Then not.", 1)
	talk_state = 0

elseif talk_state == 9072 and msgcontains(msg, 'yes') then
	NPCSay('Well, you can withdraw, deposit or use a premium coin.', 1)
	talk_state = 0	
elseif msgcontains(msg, 'prem') or msgcontains(msg, 'don') or msgcontains(msg, 'coin') then
	NPCSay('Well, you can withdraw, deposit or use a premium coin.', 1)
	talk_state = 0	
...
elseif getPlayerVocation(cid) == 2 or getPlayerVocation(cid) == 6 then
		...
		NPCSay("Sorry, I only teach druids!", 1)
		return false
		end
	end
]]--
