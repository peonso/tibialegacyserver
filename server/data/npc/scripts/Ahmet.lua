...
shopModule:addBuyableItem({'candelabr'}, 					ID_candelabrum, 8)
shopModule:addBuyableItem({'candlestick'}, 					ID_candlestick, 2)
shopModule:addBuyableItem({'bag'}, 					ID_goldenbag, 4)
...
shopModule:addBuyableItem({'backpack'}, 					ID_goldenbackpack, 10)
...
shopModule:addBuyableItem({'waterskin', 'water'}, 					ID_waterskin, 40, 1)
shopModule:addBuyableItem({'present'}, 					ID_present, 10)
shopModule:addBuyableItem({'bucket'}, 					ID_bucket, 4)
shopModule:addBuyableItem({'bottle'}, 					ID_bottle, 3)
