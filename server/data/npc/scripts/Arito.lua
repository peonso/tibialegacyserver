...
shopModule:addBuyableItem({'bread'}, 					ID_bread, 8)
shopModule:addBuyableItem({'cheese'}, 					ID_cheese, 12)
shopModule:addBuyableItem({'meat'}, 					ID_meat, 10)
shopModule:addBuyableItem({'ham'}, 					ID_ham, 16)
shopModule:addBuyableItem({'fish'}, 					ID_fish, 6)
shopModule:addBuyableItem({'lemonade'}, 					ID_mug, 3, 5, 'mug of lemonade')
shopModule:addBuyableItem({'wine'}, 					ID_mug, 4, 7, 'mug of wine')
