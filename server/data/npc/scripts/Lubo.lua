...
shopModule:addBuyableItem({'torch'}, 					ID_torch, 3)
shopModule:addBuyableItem({'rope'}, 					ID_rope, 60)
shopModule:addBuyableItem({'water hose'}, 					ID_waterhose, 10)
shopModule:addBuyableItem({'backpack'}, 					ID_backpack, 25)
shopModule:addBuyableItem({'fishing rod'}, 					ID_fishingrod, 175)
