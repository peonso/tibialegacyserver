...
shopModule:addBuyableItem({'salmon'}, 					ID_salmon, 4)
shopModule:addBuyableItem({'orange'}, 					ID_orange, 5, 0, 'oranges')
shopModule:addBuyableItem({'banana'}, 					ID_banana, 2, 0, 'bananas')
shopModule:addBuyableItem({'grape'}, 					ID_grape, 3, 0, 'grapes')
shopModule:addBuyableItem({'melon'}, 					ID_melon, 8, 0, 'melons')
shopModule:addBuyableItem({'pumpkin'}, 					ID_pumpkin, 10, 0, 'pumpkins')
shopModule:addBuyableItem({'cookie'}, 					ID_cookie, 2, 0, 'cookies')
shopModule:addBuyableItem({'roll'}, 					ID_roll, 2, 0, 'rolls')
shopModule:addBuyableItem({'egg'}, 					ID_egg, 2, 0, 'eggs')
