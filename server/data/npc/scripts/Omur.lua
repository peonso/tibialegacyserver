...
shopModule:addBuyableItem({'orange'}, 					ID_orange, 7)
shopModule:addBuyableItem({'banana'}, 					ID_banana, 3)
shopModule:addBuyableItem({'grape'}, 					ID_grape, 5)
shopModule:addBuyableItem({'melon'}, 					ID_melon, 10)
shopModule:addBuyableItem({'carrot'}, 					ID_carrot, 4)
