...
keywordHandler:addKeyword({'mission QuestValue(320)=3'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'The reports from Northport have already arrived here and our progress is astonishing. We think it is possible to create an astral bridge between our bases. Are you interested to assist us with this?'})
...
keywordHandler:addKeyword({'yes topic=33'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Good, just take this spectral essence and use it on the strange carving in this building as well as on the corresponding tile in our base at Northport ...'})
