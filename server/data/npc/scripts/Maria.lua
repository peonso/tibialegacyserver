...
shopModule:addBuyableItem({'cookie'}, 					ID_cookie, 5)
shopModule:addBuyableItem({'egg'}, 					ID_egg, 2)
shopModule:addBuyableItem({'tomato'}, 					ID_tomato, 5)
shopModule:addBuyableItem({'lemonade'}, 					ID_mug, 2, 5, 'mug of lemonade')
shopModule:addBuyableItem({'beer'}, 					ID_mug, 2, 3, 'mug of beer')
shopModule:addBuyableItem({'wine'}, 					ID_wine, 3, 7, 'mug of wine')
shopModule:addBuyableItem({'water'}, 					ID_mug, 1, 1, 'mug of water')
