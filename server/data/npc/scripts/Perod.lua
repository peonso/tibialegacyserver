...
shopModule:addBuyableItem({'bag'}, 					ID_camouflagebag, 5)
shopModule:addBuyableItem({'backpack'}, 					ID_camouflagebackpack, 20)
...
shopModule:addBuyableItem({'cup'}, 					ID_cup, 2)
shopModule:addBuyableItem({'jug'}, 					ID_jug, 10)
