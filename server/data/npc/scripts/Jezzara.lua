...
shopModule:addBuyableItem({'dragon ham'}, 					ID_dragonham, 25)
shopModule:addBuyableItem({'meat'}, 					ID_meat, 10)
shopModule:addBuyableItem({'ham'}, 					ID_ham, 15)
shopModule:addBuyableItem({'salmon'}, 					ID_salmon, 7)
shopModule:addBuyableItem({'fish'}, 					ID_fish, 6)
shopModule:addBuyableItem({'orange'}, 					ID_orange, 9)
shopModule:addBuyableItem({'banana'}, 					ID_banana, 5)
shopModule:addBuyableItem({'grape'}, 					ID_grape, 8)
shopModule:addBuyableItem({'melon'}, 					ID_melon, 13)
shopModule:addBuyableItem({'carrot'}, 					ID_carrot, 8)
shopModule:addBuyableItem({'tomato'}, 					ID_tomato, 10)
