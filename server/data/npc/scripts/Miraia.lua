...
shopModule:addBuyableItem({'lemonade'}, 					ID_mug, 3, 5, 'mug of lemonade')
shopModule:addBuyableItem({'water'}, 					ID_mug, 2, 1, 'mug of water')
shopModule:addBuyableItem({'milk'}, 					ID_mug, 5, 6, 'mug of milk')
