...
if msgcontains(msg, "mission") or msgcontains(msg, "pass") or msgcontains(msg, "quest") then
	...
	npcHandler:say("You're supposed to kill green djinns, and still here you are..", 1)
	talk_state = 0
	...
	npcHandler:story("You want another test?", 9)
...
elseif talk_state == 801 and msgcontains(msg, "yes") then
	...
	npcHandler:story("Go in through the backdoor of the green djinn fortress, and assassinate 100 djinns. ...", 5)
...
elseif talk_state == 701 and msgcontains(msg, "yes") then
	if getPlayerStorageValue(cid,8094) >= 1 and getPlayerStorageValue(cid,8178) == 1 then
		if getPlayerStorageValue(cid,8165) >= 1 then
			...
			npcHandler:say("On the top floor of the green djinn fortress is a chest or a box, steal what's inside it and bring it to me! see you in a bit!", 1)
