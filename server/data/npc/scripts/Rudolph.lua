...
shopModule:addBuyableItem({'jacket'}, 					ID_jacket, 12)
shopModule:addBuyableItem({'tunic'}, 					ID_tunic, 10)
shopModule:addBuyableItem({'cape'}, 					ID_cape, 9)
shopModule:addBuyableItem({'leather legs'}, 					ID_leatherlegs, 10)
shopModule:addBuyableItem({'scarf'}, 					ID_scarf, 15)
