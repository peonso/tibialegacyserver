...
shopModule:addSellableItem({'serpent sword'}, 					ID_serpentsword, 900)
shopModule:addSellableItem({'dragon hammer'}, 					ID_dragonhammer, 2000)
shopModule:addSellableItem({'giant sword'}, 					ID_giantsword, 17000)
shopModule:addSellableItem({'poison dagger'}, 					ID_poisondagger, 50)
shopModule:addSellableItem({'scimitar'}, 					ID_scimitar, 150)
shopModule:addSellableItem({'skull staff'}, 					ID_skullstaff, 6000)
shopModule:addSellableItem({'knight axe'}, 					ID_knightaxe, 2000)
shopModule:addSellableItem({'tower shield'}, 					ID_towershield, 8000)
shopModule:addSellableItem({'black shield'}, 					ID_blackshield, 800)
shopModule:addSellableItem({'ancient shield'}, 					ID_ancientshield, 900)
shopModule:addSellableItem({'vampire shield'}, 					ID_vampireshield, 15000)
shopModule:addSellableItem({'warrior helmet'}, 					ID_warriorhelmet, 5000)
shopModule:addSellableItem({'knight armor'}, 					ID_knightarmor, 5000)
shopModule:addSellableItem({'knight legs'}, 					ID_knightlegs, 5000)
shopModule:addSellableItem({'strange helmet'}, 					ID_strangehelmet, 500)
shopModule:addSellableItem({'dark armor'}, 					ID_darkarmor, 400)
shopModule:addSellableItem({'dark helmet'}, 					ID_darkhelmet, 250)
shopModule:addSellableItem({'mystic turban'}, 					ID_mysticturban, 150)

shopModule:addBuyableItem({'ice rapier'}, 					ID_icerapier, 5000)
shopModule:addBuyableItem({'serpent sword'}, 					ID_serpentsword, 6000)
shopModule:addBuyableItem({'ancient shield'}, 					ID_ancientshield, 5000)
shopModule:addBuyableItem({'dark armor'}, 					ID_darkarmor, 1500)
shopModule:addBuyableItem({'dark helmet'}, 					ID_darkhelmet, 1000)
