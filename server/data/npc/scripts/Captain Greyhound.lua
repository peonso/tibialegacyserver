...
elseif msgcontains(msg, 'ab\'dendriel') then
	if isPlayerVip(cid) == TRUE then
		...
		npcHandler:say('Do you seek a passage to Ab\'Dendriel for 80 gold?')
		talk_state = 1
		town_boat = abdendriel
		price = 80
	end	
...
elseif msgcontains(msg, 'edron') then
	if isPlayerVip(cid) == TRUE then
		...
		npcHandler:say('Do you seek a passage to Edron for 110 gold?')
		talk_state = 1
		town_boat = edron
		price = 110
	end
...
elseif msgcontains(msg, 'venore') then
	if isPlayerVip(cid) == TRUE then
		...
		npcHandler:say('Do you seek a passage to Venore for 130 gold?')
		talk_state = 1
		town_boat = venore
		price = 130
	end	
