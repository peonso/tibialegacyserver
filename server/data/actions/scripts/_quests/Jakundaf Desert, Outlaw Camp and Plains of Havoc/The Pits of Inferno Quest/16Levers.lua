function onUse(cid, item, fromPosition, itemEx, toPosition)
	...
	local cfg = {        
		lever1 = getThingfromPos(levers.leverpos1),
		lever2 = getThingfromPos(levers.leverpos2),
		lever3 = getThingfromPos(levers.leverpos3),
		lever4 = getThingfromPos(levers.leverpos4),
		lever5 = getThingfromPos(levers.leverpos5),
		lever6 = getThingfromPos(levers.leverpos6),
		lever7 = getThingfromPos(levers.leverpos7),
		lever8 = getThingfromPos(levers.leverpos8),
		lever9 = getThingfromPos(levers.leverpos9),
		lever10 = getThingfromPos(levers.leverpos10),
		lever11 = getThingfromPos(levers.leverpos11),
		lever12 = getThingfromPos(levers.leverpos12),
		lever13 = getThingfromPos(levers.leverpos13),
		lever14 = getThingfromPos(levers.leverpos14),
		lever15 = getThingfromPos(levers.leverpos15),
		wall = getThingfromPos(levers.wall1),
		wallb = getThingfromPos(levers.wall2)}
