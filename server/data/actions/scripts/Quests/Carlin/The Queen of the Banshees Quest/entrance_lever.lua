...
local gettile = getThingfromPos(tilepos)
    ...
    if item.uid == 10010 and item.itemid == 1945 and getmw.itemid == 1498 and gettile.itemid == 407 then
        doRemoveItem(getmw.uid,1)
        doTransformItem(item.uid,item.itemid+1)
        doCreateItem(410, stairpos)
    elseif item.uid == 10010 and item.itemid == 1946 and getmw.itemid == 0 and gettile.itemid == 410  then
